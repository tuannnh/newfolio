...
export default class InformationSection {
    ...
    setStatic() {
        this.objects.add({
            ...
            floorShadowTexture: this.resources.items
                .informationStaticFloorShadowTexture,
        ...
        this.links.options = [
            {
                ...
                labelTexture: this.resources.items
                    .informationContactTwitterLabelTexture
            },
            {
                href: "https://github.com/tuannnh",
                labelTexture: this.resources.items
                    .informationContactGithubLabelTexture
            },
            {
                href: "https://www.linkedin.com/in/hung-tuan/",
                labelTexture: this.resources.items
                    .informationContactLinkedinLabelTexture
            },
            {
                href: "mailto:shiva.lucius@gmail.com",
                labelTexture: this.resources.items
                    .informationContactMailLabelTexture
            }
        ];
